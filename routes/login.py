...
# Generate an encryption key if not already set
ENCRYPTION_KEY = os.getenv("TOKEN_ENCRYPTION_KEY", Fernet.generate_key().decode())
...
def set_auth_cookie(response, token):
    ...
    response.set_cookie("access_token", encrypted_token, httponly=True, secure=True, samesite="Lax")
    return response
